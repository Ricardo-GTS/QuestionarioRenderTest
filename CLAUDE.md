...
- Aluno pode editar seus dados de conta (nome, senha, e-mail). Não pode excluir a própria conta (removido depois do MVP — só o admin exclui usuários, em Usuários) nem alterar a matrícula depois de preenchida.
