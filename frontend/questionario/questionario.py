...
from questionario.pages.admin_removed import admin_removed_page
...
from questionario.style import FONT_STYLESHEETS, GLOBAL_STYLE

app = rx.App(style=GLOBAL_STYLE, stylesheets=FONT_STYLESHEETS)
...
app.add_page(admin_removed_page, route="/admin/removed")
